...
CREATE TABLE `users` (
                         `uuid` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT 'uuid',
                         `name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT 'Nombre completo',
                         `surnames` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
                         `mail` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT 'email',
                         `pass` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT 'Contraseña encriptada con md5',
                         ...
                         `uuidUserCreation` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT 'uuid del usuairo que la creo',
                         `datehourCreation` datetime NOT NULL COMMENT 'Fecha y hora de creación',
                         `uuidUserModification` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
                         `datehourModification` datetime DEFAULT NULL COMMENT 'fecha y hora de la ultima modificación',
                         PRIMARY KEY (`uuid`),
                         UNIQUE KEY `mail_UNIQUE` (`mail`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='Tabla de usuarios';

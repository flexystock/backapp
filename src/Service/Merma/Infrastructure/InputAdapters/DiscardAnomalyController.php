...
class DiscardAnomalyController extends AbstractController
{
    use PermissionControllerTrait;

    public function __construct(
        private readonly DiscardAnomalyUseCaseInterface $useCase,
    ...
    #[Route('/api/merma/event/{id}/discard', name: 'api_merma_event_discard', methods: ['POST'])]
    #[OA\Post(
    ...
    public function __invoke(Request $request, int $id): JsonResponse
    {
        try {
            ...
            $dto    = new DiscardAnomalyRequest($uuidClient, $id);
            ...
            return new JsonResponse(['status' => 'success', 'message' => 'ANOMALY_DISCARDED'], Response::HTTP_OK);
        } catch (\RuntimeException $e) {
            return $this->handleRuntimeException($e);
        } catch (\Throwable $e) {
            $this->logger->error('Unexpected error discarding anomaly', ['exception' => $e->getMessage()]);

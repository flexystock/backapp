...
class UserActiveController extends AbstractController
{
    ...
    public function __construct(
        private readonly ToggleUserActiveInputPort $toggleUserActiveInputPort,
    ...
    #[OA\Post(
        ...
        responses: [
            new OA\Response(
                ...
                content: new OA\JsonContent(
                    properties: [
                        new OA\Property(property: 'message', type: 'string', example: 'USER_STATUS_UPDATED'),
    ...
    public function __invoke(Request $request): JsonResponse
    {
        ...
        $dto = new ToggleUserActiveRequest(
        ...
        try {
            $isActive = $this->toggleUserActiveInputPort->toggle($dto);
    ...
    private function handleDomainException(\RuntimeException $exception): JsonResponse
    {
        return match ($exception->getMessage()) {
            ...
            default => $this->json(['message' => 'USER_STATUS_UPDATE_FAILED'], Response::HTTP_INTERNAL_SERVER_ERROR),
        };
    }
}

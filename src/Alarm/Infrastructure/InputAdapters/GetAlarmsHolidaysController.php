...
class GetAlarmsHolidaysController extends AbstractController
{
    ...
    #[Route('/api/alarm/holidays', name: 'api_alarm_get_holidays', methods: ['GET'])]
    #[OA\Get(
        path: '/api/alarm/holidays',
        summary: 'Obtiene los días festivos configurados',
        parameters: [
            new OA\Parameter(
                name: 'uuidClient',
                in: 'query',
                ...
                description: 'UUID del cliente para recuperar sus festivos'
            ),
        ],
        tags: ['Alarm'],
        responses: [
    ...
    public function __invoke(Request $request): JsonResponse
    {
        try {
            ...
            $response = $this->getHolidaysUseCase->execute($dto);
            ...
            $this->logger->error('Unexpected error fetching holidays', [
